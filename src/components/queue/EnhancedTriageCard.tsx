...
interface EnhancedTriageCardProps {
  ticket: any;
  queues: any[];
  onUpdate: () => void;
  onAssess: (patient: { id: string; name: string; ticketId: string }) => void;
}

export const EnhancedTriageCard = ({
  ticket,
  queues,
  onUpdate,
  onAssess,
}: EnhancedTriageCardProps) => {
      ...
      <CardContent className="p-6">
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2 pt-2 border-t">
            ...
            <QueueActions ticket={ticket} queues={queues} onUpdate={onUpdate} />
          </div>
        </div>
      </CardContent>
    </Card>
